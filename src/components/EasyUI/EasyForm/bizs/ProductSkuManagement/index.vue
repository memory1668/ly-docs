...
export default {
  ...
  data() {
    return {
       ...
       */
      columnsTemplate: [
        { label: '价格（元）', isEdit: false, editable: true, prop: 'price' },
        { label: '库存', isEdit: false, editable: true, prop: 'inventory' },
        { label: '规格数量', isEdit: false, editable: true, prop: 'unit_num' }
        // { label: '规格编码', isEdit: false, editable: true, prop: 'sku_code' },
        // { label: '原价', isEdit: false, editable: true, prop: 'market_price' },
        // { label: '重量(kg)', isEdit: false, editable: true, prop: 'weight' },
        // { label: '条形码', isEdit: false, editable: true, prop: 'bar_code' },
      ],
      /**
       * 标题栏
       */
