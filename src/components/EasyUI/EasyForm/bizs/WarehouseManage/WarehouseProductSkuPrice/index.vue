    ...
    <el-table :data="skusTableData" border stripe>
      ...
      >
        ...
        <template slot-scope="scope">
          <!--v-model="input4"-->
          <el-input v-if="col.editable" v-model="skusTableData[scope.$index][col.prop]" size="normal" :placeholder=" col.label" />
  ...
  data() {
    return {
      ...
      /**
         ...
         */
      columnsTemplate: [
        { label: '售价（元）', editable: true, batchEditable: true, prop: 'price' },
        { label: '进货价（元）', editable: true, batchEditable: true, prop: 'purchase_price' },
